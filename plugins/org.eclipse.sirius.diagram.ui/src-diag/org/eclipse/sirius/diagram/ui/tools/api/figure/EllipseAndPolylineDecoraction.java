 ...
 * 
 */
public class EllipseAndPolylineDecoraction extends EllipseDecoration {
     ...
     */
    public EllipseAndPolylineDecoraction() {
        super();
    ...
    public Rectangle getBounds() {
        if (bounds == null) {
            if (polylineDecoration != null) {
                bounds = super.getBounds().getUnion(polylineDecoration.getPoints().getBounds()).getExpanded(getLineWidth() / 2, getLineWidth() / 2);
            } else {
