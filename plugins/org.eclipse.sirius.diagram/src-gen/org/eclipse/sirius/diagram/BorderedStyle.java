 ...
 * Color</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.BorderedStyle#getBorderLineStyle <em>
 * Border Line Style</em>}</li>
>>>>>>> pcdavid/master
 * </ul>
 *
...
<<<<<<< HEAD
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Border Line Style</em>' attribute isn't clear,
